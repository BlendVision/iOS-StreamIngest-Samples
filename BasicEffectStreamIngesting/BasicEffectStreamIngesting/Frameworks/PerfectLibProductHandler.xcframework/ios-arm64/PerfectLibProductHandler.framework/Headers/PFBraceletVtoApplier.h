...
NS_SWIFT_NAME(BraceletVtoApplier)
/// A class to perform virtual try-on effects.
@interface PFBraceletVtoApplier : PFHandVtoApplier

/// Initialize a `PFBraceletVtoApplier` instance.
/// @param target The target should be either `PFBraceletCam` or `PFPhotoBracelet`.
- (instancetype _Nullable)initWithTarget:(id)target NS_DESIGNATED_INITIALIZER;

/**
 Apply the bracelet effects of the products specified by the list of `VtoSetting`.
...
/**
 Apply the bracelet effects specified by the list of `EffectId` on current specified face.
...
/**
 Remove all the existing bracelet effects on image.
...
/**
Unavailable. Use `-initWithTarget:` for `PFBraceletVtoApplier` object initializing.
*/
