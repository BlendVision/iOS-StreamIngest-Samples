...
NS_SWIFT_NAME(WatchVtoApplier)
/// A class to perform virtual try-on effects.
@interface PFWatchVtoApplier : PFHandVtoApplier

/// Initialize a `PFWatchVtoApplier` instance.
/// @param target The target should be either `PFWatchCam` or `PFPhotoWatch`.
- (instancetype _Nullable)initWithTarget:(id)target NS_DESIGNATED_INITIALIZER;

/**
 Apply the watch effects of the products specified by the list of `VtoSetting`.
...
/**
 Apply the watch effects specified by the list of `EffectId` on current specified face.
...
/**
 Remove all the existing watch effects on image.
...
/**
Unavailable. Use `-initWithTarget:` for `PFWatchVtoApplier` object initializing.
*/
