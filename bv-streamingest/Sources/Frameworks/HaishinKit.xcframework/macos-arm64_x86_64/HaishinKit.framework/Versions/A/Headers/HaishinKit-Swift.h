...
SWIFT_AVAILABILITY(tvos,introduced=17.0)
...
SWIFT_CLASS("_TtC10HaishinKit21IOCaptureVideoPreview")
@interface IOCaptureVideoPreview : NSView
- (void)awakeFromNib;
...
@property (nonatomic) uint16_t currentFPS;
...
@interface IOStream (SWIFT_EXTENSION(HaishinKit)) <SCStreamOutput>
- (void)stream:(SCStream * _Nonnull)stream didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer ofType:(SCStreamOutputType)type SWIFT_AVAILABILITY(macos,introduced=12.3);
@end




SWIFT_CLASS("_TtC10HaishinKit45IOVideoCaptureUnitVideoDataOutputSampleBuffer") SWIFT_AVAILABILITY(tvos,introduced=17.0)
@interface IOVideoCaptureUnitVideoDataOutputSampleBuffer : NSObject <AVCaptureVideoDataOutputSampleBufferDelegate>
